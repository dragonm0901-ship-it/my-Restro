        ...
        <div className="min-h-screen pt-32 pb-24" style={{ background: '#FAFAFA', color: '#09090B' }}>
            <div className="max-w-4xl mx-auto px-6">
                <div className="text-center mb-16">
                    <h1 className="text-5xl font-bold font-['Outfit'] mb-6 tracking-tight">About myRestro</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-24">
                    <div>
                        ...
                        <p className="text-gray-600 leading-relaxed mb-4">
                            Founded in 2026, myRestro started from a simple observation: while dining out is a joy, running a restaurant is incredibly complex. Disconnected systems, paper tickets, and manual billing were slowing down great hospitality.
                        </p>
